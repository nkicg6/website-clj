#+HTML: <div id="edn">
#+HTML: {:topic "programming" :title "Consistent style for scientific figures with ggplot2" :date "2020-08-30" :updated "{{{time(%Y-%m-%d %a)}}}" :tags ["ggplot2", "science", "figures", "R", "statistics"]}
#+HTML: </div>
