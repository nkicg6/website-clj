#+HTML: <div id="edn">
#+HTML: {:topic "programming" :title "Making a lookup table (LUT) for ImageJ from an existing image" :date "2020-01-05" :updated "{{{time(%Y-%m-%d %a)}}}" :tags ["imagej" "image-analysis"]}
#+HTML: </div>
