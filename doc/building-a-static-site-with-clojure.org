...
The first thing I did was make a new directory in my =resources/= directory called =img=, since I want all my pages to live here. The structure looks like this:
#+BEGIN_EXAMPLE
resources/
├── home
│   └── index.html
